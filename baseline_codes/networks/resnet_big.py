...
class CustomModel(nn.Module):
  def __init__(self):
    ...
    self.resnet.fc4 = nn.Linear(128,64)
    self.resnet.fc5 = nn.Linear(64,32)
    self.resnet.fc6 = nn.Linear(32,3)
  ...
  def forward(self, x):
    ...
    out_final = self.resnet.fc4(F.relu(out))
    out_final = self.resnet.fc5(F.relu(out_final))
    out_final = self.resnet.fc6(F.relu(out_final))
    
    #return out - out = features(batchsize,128)
